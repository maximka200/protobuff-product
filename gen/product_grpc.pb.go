...
const (
	Product_NewProduct_FullMethodName    = "/product.Product/NewProduct"
...
type ProductClient interface {
	NewProduct(ctx context.Context, in *NewProductRequest, opts ...grpc.CallOption) (*NewProductResponse, error)
...
func (c *productClient) NewProduct(ctx context.Context, in *NewProductRequest, opts ...grpc.CallOption) (*NewProductResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NewProductResponse)
...
type ProductServer interface {
	NewProduct(context.Context, *NewProductRequest) (*NewProductResponse, error)
...
func (UnimplementedProductServer) NewProduct(context.Context, *NewProductRequest) (*NewProductResponse, error) {
...
func _Product_NewProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServer).NewProduct(ctx, req.(*NewProductRequest))
	}
